# Sample report: what a converged run looks like

30 illustrative, **anonymized** rows: file paths, identifiers, and specifics are synthetic, but the severities, defect classes, and shape of each finding mirror what a real converged run produces. This excerpt shows the output format and the two convergence ledgers.
...
Fourteen rounds is not the skill failing; it's what "done" costs when you require proof. Run it on your own product: `/application-auditor`.
